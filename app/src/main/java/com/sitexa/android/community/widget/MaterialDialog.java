...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setBackgroundResource(R.drawable.btn_dialog_selector);
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setBackgroundResource(R.drawable.btn_dialog_selector);
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contv = LayoutInflater.from(mContext).inflate(R.layout.popupwindow_common_materialdialog, null);
            contv.setFocusable(true);
            contv.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.common_material_dialog_window);
...
//7
        ...
        /**
         * set positive aa_btn_dialog_selector
         *
         * @param text     the name of aa_btn_dialog_selector
         * @param listener
         */
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(R.drawable.bg_dialog_material_card);
        ...
        /**
         * set negative aa_btn_dialog_selector
         *
         * @param text     the name of aa_btn_dialog_selector
         * @param listener
         */

...
public interface UserRestApi {
    ...
    static final String API_BASE_URL = "http://192.168.0.100:8080/sitexa-api/";

    /**
     * Api url for getting all users
     */
    //static final String API_URL_GET_USER_LIST = API_BASE_URL + "users.json";
    static final String API_URL_GET_USER_LIST = API_BASE_URL + "user/getUserList";

    /**
     * Api url for getting a user profile: Remember to concatenate id + 'json'
     */
    //static final String API_URL_GET_USER_DETAILS = API_BASE_URL + "user_";
    static final String API_URL_GET_USER_DETAILS = API_BASE_URL + "user/findUserById?userId=";

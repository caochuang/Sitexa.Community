 ...
 */
public class SetPassword extends UseCase {
    private final UserRepository userRepository;

    @Inject
    public SetPassword(UserRepository userRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    protected Observable buildUseCaseObservable(Object... param) {
        return this.userRepository.setPassword((Map<String, String>) param[0]);
    }
}
